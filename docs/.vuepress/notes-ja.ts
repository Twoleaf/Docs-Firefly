  ...
  sidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'Halo移行', link: 'halo-to-Firefly/', icon: 'ri:exchange-line' },
        { text: 'Hexo移行', link: 'hexo-to-Firefly/', icon: 'ri:exchange-line' },
        { text: 'HTMLインポート', link: 'html-import/', icon: 'ri:html5-line' },
        { text: 'Hugo移行', link: 'hugo-to-Firefly/', icon: 'ri:exchange-line' },
        { text: 'Jekyll移行', link: 'jekyll-to-Firefly/', icon: 'ri:exchange-line' },
        { text: 'Markdownインポート', link: 'markdown-import/', icon: 'ri:markdown-line' },
        { text: 'Typecho移行', link: 'typecho-to-Firefly/', icon: 'ri:exchange-line' },
        { text: 'WordPress移行', link: 'wordpress-to-Firefly/', icon: 'ri:wordpress-line' },
