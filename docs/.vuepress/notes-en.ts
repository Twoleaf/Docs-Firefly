  ...
  sidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'Halo Migration', link: 'halo-to-Firefly/', icon: 'ri:exchange-line' },
        { text: 'Hexo Migration', link: 'hexo-to-Firefly/', icon: 'ri:exchange-line' },
        { text: 'HTML Import', link: 'html-import/', icon: 'ri:html5-line' },
        { text: 'Hugo Migration', link: 'hugo-to-Firefly/', icon: 'ri:exchange-line' },
        { text: 'Jekyll Migration', link: 'jekyll-to-Firefly/', icon: 'ri:exchange-line' },
        { text: 'Markdown Import', link: 'markdown-import/', icon: 'ri:markdown-line' },
        { text: 'Typecho Migration', link: 'typecho-to-Firefly/', icon: 'ri:exchange-line' },
        { text: 'WordPress Migration', link: 'wordpress-to-Firefly/', icon: 'ri:wordpress-line' },
